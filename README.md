...
# Dependencies
    ...
    gem install ruby-lsp   # Ruby LSP — install globally, NOT via bundle exec
# Installed Plugins
    ...
    lsp - uses Neovim's native LSP (vim.lsp.enable) with ruby-lsp configured in lsp/ruby-lsp.lua
# TODO
